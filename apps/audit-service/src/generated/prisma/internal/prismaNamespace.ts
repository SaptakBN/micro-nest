...
export const UserActionsOrderByRelevanceFieldEnum = {
  id: 'id',
  userId: 'userId',
  action: 'action'
} as const

export type UserActionsOrderByRelevanceFieldEnum = (typeof UserActionsOrderByRelevanceFieldEnum)[keyof typeof UserActionsOrderByRelevanceFieldEnum]
